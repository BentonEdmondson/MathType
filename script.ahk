...
Hotstring(":*?B0COX:cancel", Func("SwapInChar").Bind("̸", 5))
...
Hotstring(":*?B0COX:cdots", Func("SwapInChar").Bind("⋯", 2))
Hotstring(":*?B0COX:vdots", Func("SwapInChar").Bind("⋮", 2))
Hotstring(":*?B0COX:ddots", Func("SwapInChar").Bind("⋱", 1))
...
Hotstring(":*?B0COX:ddot", Func("SwapInChar").Bind("̈", 3))
...
Hotstring(":*?B0COX:Del", Func("SwapInChar").Bind("∆", 2))
Hotstring(":*?B0COX:hat", Func("SwapInChar").Bind("̂", 2))
Hotstring(":*?B0COX:bar", Func("SwapInChar").Bind("̅", 2))
Hotstring(":*?B0COX:vec", Func("SwapInChar").Bind("⃗", 2))
Hotstring(":*?B0COX:dot", Func("SwapInChar").Bind("̇", 2))
...
Hotstring(":*?B0COX:ul", Func("SwapInChar").Bind("̲", 1))
