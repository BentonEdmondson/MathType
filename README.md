...
# TODO:
- Give the script a custom tray icon
...
- Make a program to point out all concerning spots, e.g. "are you sure nobody ever wants i∫ instead of ∬"
- In `mappings/` add `undefined` in spots where no such Unicode character exists
- When script is suspended, change font to italics and elevation to standard.
- Consider adding a variation selector to prevent any arrows from becoming emojis.
- Make the script start suspended, not enabled.